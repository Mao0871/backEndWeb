...
// Root route - can redirect to a main page or render an index page
app.get('/', (req, res) => {
    res.redirect('/'); // Redirecting to the goods management page as an example
});

// Adjusted route to render EJS template for goods management
...
app.get('/', (req, res) => res.render('backendLogin.html'));
